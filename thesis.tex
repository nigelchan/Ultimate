...
\ifpdf
    \pdfinfo { /Title  (CUED PhD and MPhil Thesis Classes)
               ...
               /Subject (Uniform Convergence on Nonlinear Cointegrating Regression)
               /Keywords (PhD, Thesis)}
    \pdfcatalog { /PageMode (/UseOutlines)
                  /OpenAction (fitbh)  }
\fi

\title{Uniform Convergence on Nonlinear Cointegrating Regression}
...
% insert below the file name that contains the crest in-place of 'UnivShield'
  \crest{\includegraphics[width=50mm]{UsydLogo}}
